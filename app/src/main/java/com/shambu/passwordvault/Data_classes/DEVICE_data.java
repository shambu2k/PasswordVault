...
public class DEVICE_data {
    ...
    public DEVICE_data(int sqldeviceID, String data_type, String device_Type, String device_name, String PINorPassorPattern, String securityType) {
    ...
    public DEVICE_data(String data_type, String device_Type, String device_name, String PINorPassorPattern, String securityType) {
        this.data_type = data_type;
        this.device_Type = device_Type;
        this.device_name = device_name;
        this.PINorPassorPattern = PINorPassorPattern;
