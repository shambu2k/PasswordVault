...
public class otherwebsites_fragment extends Fragment implements ClickAdapterListener {

    private SharedPreferences pref;

    @BindView(R.id.otherwebsites_rv)
    RecyclerView rv;

    @BindView(R.id.otherwebsites_fab)
    ...
    private void deleteRows() {
        ...
        if(adapter.getItemCount()==selectedItemPositions.size()){
            viewModel.deleteAll(OTHER_TYPE);
            actionMode = null;
        }
        else {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                save_butt.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        GSMOWOM_data sample_data = new GSMOWOM_data(OTHER_TYPE,
                                TextUtils.isEmpty(site.getText().toString()) ? "" : site.getText().toString(),
                                TextUtils.isEmpty(mail.getText().toString()) ? "" : mail.getText().toString(),
                                TextUtils.isEmpty(phnum.getText().toString()) ? "" : phnum.getText().toString(),
                                TextUtils.isEmpty(userid.getText().toString()) ? "" : userid.getText().toString(),
