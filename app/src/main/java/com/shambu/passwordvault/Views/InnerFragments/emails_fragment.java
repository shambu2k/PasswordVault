...
import static com.shambu.passwordvault.Constants.MAIL_TYPE;

public class emails_fragment extends Fragment implements ClickAdapterListener {

    private SharedPreferences pref;

    @BindView(R.id.othermails_rv)
    RecyclerView rv;

    @BindView(R.id.othermails_fab)
    ...
    private static final String msg = emails_fragment.class.getSimpleName();
  ...
  /*  private void sorter(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.emails_frag_layout, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                save_butt.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        GSMOWOM_data sample_data = new GSMOWOM_data(MAIL_TYPE,
                                TextUtils.isEmpty(site.getText().toString()) ? "" : site.getText().toString(),
                                TextUtils.isEmpty(mail.getText().toString()) ? "" : mail.getText().toString(),
                                TextUtils.isEmpty(phnum.getText().toString()) ? "" : phnum.getText().toString(),
                                TextUtils.isEmpty(userid.getText().toString()) ? "" : userid.getText().toString(),
